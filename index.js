...
const mainMenuTemp = [
  {
    ...
    submenu: [
      ...
      {
        label: '窗口',
        accelerator: process.platform === 'darwin' ? 'Alt+Cmd+L' : 'Ctrl+Shift+L',
        click(){
          createNewWindow();
        }
      }
...
function createGameWindow(){
  gameWindow = new BrowserWindow({width: 330, height: 425,title: 'gameWindow'})
...
function createNewWindow(){
  newWindow = new BrowserWindow({width: 330, height: 425,title: 'newWindow'})
